...
public class QuizDB {
	...
	static {
		...
		q.addChoice(new Choice(new BooleanSolution(false), new TranslatedString("41","41")));
		q.addChoice(new Choice(new BooleanSolution(true), new TranslatedString("42","42")));
		q.addChoice(new Choice(new BooleanSolution(false), new TranslatedString("43","43")));
		...
		q.setAnswerHeader(new TranslatedString("The result is","Das Ergebnis ist"));
		q.addChoice(new Choice(new BooleanSolution(true), new TranslatedString("False","Falsch")));
		q.addChoice(new Choice(new BooleanSolution(false), new TranslatedString("True","Richtig")));
