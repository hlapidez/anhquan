 ...
 * Roy T. Fielding<br>
 * <br>
 * Concurrency note: contrary to the {@link org.restlet.client.Uniform} class and its
...
public abstract class UniformResource {
     ...
     * the result of
     * {@link org.restlet.client.service.StatusService#getStatus(Throwable, UniformResource)}
     * .
     * 
     * @param throwable
