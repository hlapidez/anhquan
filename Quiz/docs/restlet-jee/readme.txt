...
If you want to rebuild the whole project by yourself, you need to follow
the instructions available on the Restlet Developers Site:
http://wiki.restlet.org/developers/170-restlet.html
