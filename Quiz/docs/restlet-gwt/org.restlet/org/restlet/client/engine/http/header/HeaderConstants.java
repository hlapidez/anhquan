...
public final class HeaderConstants {
    ...
    public static final String ATTRIBUTE_HEADERS = "org.restlet.client.http.headers";

    @Deprecated
    public static final String ATTRIBUTE_VERSION = "org.restlet.client.http.version";

    public static final String ATTRIBUTE_HTTPS_CLIENT_CERTIFICATES = "org.restlet.client.https.clientCertificates";

    public static final String ATTRIBUTE_HTTPS_CIPHER_SUITE = "org.restlet.client.https.cipherSuite";

    public static final String ATTRIBUTE_HTTPS_KEY_SIZE = "org.restlet.client.https.keySize";
    
    public static final String ATTRIBUTE_HTTPS_SSL_SESSION_ID = "org.restlet.client.https.sslSessionId";
}
