 ...
 */
public class ObjectRepresentation<T> extends
    ...
    public ObjectRepresentation(T object, RemoteService remoteService) {
        this(object, (SerializationStreamFactory) remoteService);
    }
     ...
     *            stream factory.
     */
    public ObjectRepresentation(T object, ClientProxy resource) {
        this(object, (resource == null) ? null
                : (SerializationStreamFactory) resource);
    }
